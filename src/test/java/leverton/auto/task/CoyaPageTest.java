...
//
//        assertThat(page.isRedirectionToEnglishPageSucceed() && page.isLoginTextInEnglish() && page.isAboutUsTextInEnglish()).isTrue();
//
//    }
//    
//    @Test
...
//
//        assertThat(!page.isLoginTextInEnglish() && !page.isAboutUsTextInEnglish()).isTrue();
//
//    }
    ...
    public void Subscribe_with_invalid_email_should_fail() {
        ...
        assertThat(page.getErrorText().contains("This email address looks fake or invalid. Please enter a real email address.")).isTrue();
